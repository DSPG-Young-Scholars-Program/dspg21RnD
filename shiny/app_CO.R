                 ...
                 tabPanel("Filtering Method 1. OECD", value = "socio",
                          fluidRow(style = "margin: 6px;",
                                   ...
                                   column(4,
                                          ...
                                          p("To perform term matching, we used a list of artificial intelligence-related terms from the", a(href = "https://www.oecd.org/unitedstates/", "Organization for Economic Co-operation and Development", target = "_blank"), "(OECD). 
                                   ...
                                   column(8,
                                          h4(strong("Total Number of AI-Identified Abstracts:")),
                                          h5(("7933 / 690814 or ~1.15%")),
                                          h4(strong("Term Matching Results")),
                                          tabsetPanel(
                        
                                            tabPanel("Funding Sources",
                                                     h5(strong("Distribution of AI-Related Project Funding Agencies")),
                                                     plotOutput("oecd_agency"),
                                                     h5(strong("Distribution of AI-Related Project Starting Years")),
