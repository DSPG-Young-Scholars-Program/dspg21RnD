...
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
nmf_oecd <- read_csv("/home/zz3hs/git/dspg21RnD/data/dspg21RnD/nmf_OECD_10.csv")
nmf_oecd <- nmf_oecd%>%
...
## Cutoff: mean+2*sd
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
nmf_bert <- read_csv("/home/zz3hs/git/dspg21RnD/data/dspg21RnD/nmf_bert_10.csv")
nmf_bert <- nmf_bert%>%
  gather("iteration", "coherence_score", -n_topics)
...
nmf_bert2 <- read_csv("/home/zz3hs/git/dspg21RnD/data/dspg21RnD/nmf_bert2_10.csv")
nmf_bert2 <- nmf_bert2%>%
